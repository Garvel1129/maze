...
#Персонажи игры:
player = Player('AMOBA2.png', 5, win_height - 80, 4)
monster = Enemy('microb.png', win_width - 80, 280, 2)
final = GameSprite('R.png', win_width - 120, win_height - 80, 0)
